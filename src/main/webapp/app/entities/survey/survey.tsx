...
import { getSearchEntities, getEntities } from './survey.reducer';
...
export interface ISurveyState extends IPaginationBaseState {
  search: string;
}
...
export class Survey extends React.Component<ISurveyProps, ISurveyState> {
  ...
  render() {
    const { surveyList, match, totalItems } = this.props;
    return (
      <div>
        <h2 id="survey-heading">
          Surveys
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp; Create new Survey
          </Link>
        </h2>
        <Row>
          <Col sm="12">
          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('openingtime')}>
                  Openingtime <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('closingtime')}>
                  Closingtime <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {surveyList.map((survey, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    <TextFormat type="date" value={survey.updated} format={APP_DATE_FORMAT} />
                  </td>
                  <td>
                    <TextFormat type="date" value={survey.openingtime} format={APP_DATE_FORMAT} />
                  </td>
                  <td>
                    <TextFormat type="date" value={survey.closingtime} format={APP_DATE_FORMAT} />
                  </td>
