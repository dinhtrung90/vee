...
export class QuestionTypeDetail extends React.Component<IQuestionTypeDetailProps> {
  componentDidMount() {
  ...
  render() {
    ...
    return (
      <Row>
        <Col md="8">
          <h2>
            QuestionType [<b>{questionTypeEntity.id}</b>]
          </h2>
          <dl className="jh-entity-details">
            ...
            <dt>Question</dt>
            <dd>{questionTypeEntity.questionId ? questionTypeEntity.questionId : ''}</dd>
          </dl>
          <Button tag={Link} to="/entity/question-type" replace color="info">
            <FontAwesomeIcon icon="arrow-left" /> <span className="d-none d-md-inline">Back</span>
          </Button>&nbsp;
          <Button tag={Link} to={`/entity/question-type/${questionTypeEntity.id}/edit`} replace color="primary">
