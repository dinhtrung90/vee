...
import { getSearchEntities, getEntities } from './question.reducer';
...
export interface IQuestionState extends IPaginationBaseState {
  search: string;
}
      ...
      <div>
        <h2 id="question-heading">
          ...
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp; Create new Question
          </Link>
        </h2>
        <Row>
          <Col sm="12">
            ...
            <tbody>
              {questionList.map((question, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{question.text}</td>
                  <td>
                    <TextFormat type="date" value={question.updated} format={APP_DATE_FORMAT} />
                  </td>
